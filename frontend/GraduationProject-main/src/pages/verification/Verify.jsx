import VerificationImage from "../../assets/Verify.jpg"; 
    ...
    <div className="flex flex-col h-screen w-full bg-white">
      ...
      <div className="p-8 w-full max-w-7xl flex flex-col md:flex-row md:m-10">
        ...
        <div className="flex-1 flex flex-col items-start justify-center md:mr-12">
          ...
          <form className="flex flex-col w-full">
            ...
            <p className="text-sm  mb-4 flex items-start">
              Didn’t receive a code? <a href="#" className="text-[#4f9ed2]">Resend code</a>
            </p>
        ...
        <div className="flex-1 hidden md:flex items-center justify-center">
          <img src={VerificationImage} alt="Verification Illustration" className="h-auto object-contain" />
        </div>
      </div>
    </div>
  );
