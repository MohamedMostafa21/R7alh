  ...
  return (
    <section className="mb-12">
      <h2 className="text-start text-2xl font-bold mb-6">
        <Link className="main hover:text-[#4f9ed2] font-bold" to="/Home/Hotels">
          Hotels
        </Link>
      </h2>
          ...
          >
            <div className="relative">
              <Link to={`/Home/Hotel/${hotel.id}`}>
                <img
                  src={`http://localhost:5200${hotel.thumbnailUrl}`}
                  alt={hotel.name}
