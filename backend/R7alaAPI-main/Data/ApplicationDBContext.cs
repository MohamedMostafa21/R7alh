    ...
    public class ApplicationDBContext : IdentityDbContext<User, ApplicationRole, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Booking>(entity =>
            {
                ...
                entity.Property(b => b.TourGuideId).IsRequired();
                entity.Property(b => b.BookingDate).IsRequired();
                entity.Property(b => b.DurationHours).IsRequired();
                entity.Property(b => b.TotalAmount).HasColumnType("decimal(18,2)").IsRequired();
                entity.Property(b => b.BookingStatus).IsRequired();
                entity.Property(b => b.StripePaymentIntentId).HasMaxLength(100);
                entity.Property(b => b.CreatedAt).IsRequired();

                // Relationships (kept exactly as provided)
